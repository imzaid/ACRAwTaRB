# ACRAwTaRB
## Another Create React App with Typescript and Redux Boilerplate

### This project:
- is bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) and has:
  - React 16
  - React Router v4
  - Redux
  - Enzyme/Jest
- uses [create-react-app-typescript](https://github.com/wmonk/create-react-app-typescript) for Typescript
- allows for absolute source paths
  - `src/utils/http` instead of `../../../../../utils/http`
  - jest updated as well to resolve absolute paths

### Inspired by:
- [vortigern](https://barbar.github.io/vortigern/)
- [react-redux-typescript-boilerplate](https://github.com/rokoroku/react-redux-typescript-boilerplate)

---
`below is generated from create-react-app`
